...
public extension FoodzillaGraphQL {
  class RemoveRecipeFromFavouritesMutation: GraphQLMutation {
    public static let operationName: String = "removeRecipeFromFavourites"
    ...
    public struct Data: FoodzillaGraphQL.SelectionSet {
      ...
      public static var __selections: [Apollo.Selection] { [
        .field("removeRecipeFromFavourites", [RemoveRecipeFromFavourite?]?.self, arguments: ["recipeId": .variable("recipeId")]),
      ] }

      public var removeRecipeFromFavourites: [RemoveRecipeFromFavourite?]? { __data["removeRecipeFromFavourites"] }

      /// RemoveRecipeFromFavourite
      ///
      /// Parent Type: `Recipe`
      public struct RemoveRecipeFromFavourite: FoodzillaGraphQL.SelectionSet {
        public let __data: DataDict
        public init(data: DataDict) { __data = data }
        ...
        /// RemoveRecipeFromFavourite.Review
        ///
        /// Parent Type: `Review`
        ...
        /// RemoveRecipeFromFavourite.Ingredient
        ///
