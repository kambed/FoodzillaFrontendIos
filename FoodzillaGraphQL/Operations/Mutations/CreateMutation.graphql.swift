...
public extension FoodzillaGraphQL {
  class CreateMutation: GraphQLMutation {
    public static let operationName: String = "create"
    public static let document: Apollo.DocumentType = .notPersisted(
      definition: .init(
        #"""
        mutation create($firstname: String!, $lastname: String!, $username: String!, $password: String!) {
          createCustomer(
    ...
    public struct Data: FoodzillaGraphQL.SelectionSet {
      ...
      public static var __selections: [Apollo.Selection] { [
        .field("createCustomer", CreateCustomer?.self, arguments: ["customer": [
      ...
      public var createCustomer: CreateCustomer? { __data["createCustomer"] }

      /// CreateCustomer
      ///
      /// Parent Type: `Customer`
      public struct CreateCustomer: FoodzillaGraphQL.SelectionSet {
        public let __data: DataDict
        public init(data: DataDict) { __data = data }
